...
smgBinomRequiredSampleSize(desired.power, mut.rate, samp.sizes, eff.size, alpha.level)
```
...
smgBbdPoweredEffectSize(possible.eff.sizes, desired.power, mut.rate, cv, num.samples, alpha.level)
```
